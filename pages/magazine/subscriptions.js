    ...
    <Layout name='magazine' desc='I-predict Magazine'>
      ...
      <div className='mx-4'>
        ...
        <div
          ...
          data-aos-easing='ease-out-back'
          data-aos-delay='100'
          className='space-y-7 font-bold text-green-500 text-center mb-10'
        >
        ...
        <div className='my-6'>
          <div className='flex md:flex-row flex-col justify-center items-center space-y-4 md:space-y-0'>
            ...
            <div
              ...
              data-aos-easing='ease-out-back'
              data-aos-delay='1000'
              className='border shadow-md pt-14 px-6 rounded-2xl bg-gray-100 md:-mr-2'
            >
              ...
              >
                <Text className='font-semibold'>Pay with coins</Text>
              </div>
            </div>
            {/* 1 year */}
            <div
              ...
              data-aos-easing='ease-out-back'
              // data-aos-delay='1000'
              className='border shadow-lg pt-14 pb-8 px-6 rounded-2xl text-white z-10 border-emerald-500 bg-blue-700'
            >
            ...
            <div
              ...
              data-aos-easing='ease-out-back'
              data-aos-delay='1500'
              className='border shadow-md pt-14 px-6 rounded-2xl bg-gray-100 md:-ml-2'
            >
